...
cd IOIPSL
cp -f ../LMDZ.COMMON/arch/arch-CICLADifort.env arch
cp -f ../LMDZ.COMMON/arch/arch-CICLADifort.path arch
cp -f ../LMDZ.COMMON/arch/arch-CICLADifort.fcm arch

## 3. build ioipsl:
./makeioipsl_fcm -arch CICLADifort -job 8 > makeioipsl.out 2>&1
