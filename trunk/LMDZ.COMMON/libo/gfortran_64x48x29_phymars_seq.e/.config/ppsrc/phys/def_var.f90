...
if(ierr/=NF_NOERR) then
   ...
   call abort_physic("def_var",'netcdf definition problem',1)
endif
...
if(ierr/=NF_NOERR) then
   ...
   write(*,*) NF_STRERROR(ierr)
   call abort_physic("def_var",'netcdf title attribute problem',1)
endif
...
if(ierr/=NF_NOERR) then
   ...
   write(*,*) NF_STRERROR(ierr)
   call abort_physic("def_var",'netcdf units attribute problem',1)
endif
