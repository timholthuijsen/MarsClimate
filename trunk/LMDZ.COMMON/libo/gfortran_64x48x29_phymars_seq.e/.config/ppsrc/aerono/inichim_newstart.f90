...
! ions: 0
      ...
      if (igcm_co2plus /= 0) then
         ...
         if (igcm_o2plus == 0 .or. igcm_oplus == 0 .or. igcm_coplus == 0          &
              ...
              .or. igcm_hcoplus == 0 .or. igcm_h2oplus == 0                      &
              .or. igcm_h3oplus == 0.or. igcm_ohplus == 0 .or.igcm_elec == 0) then
            write(*,*)'inichim_newstart error:'
            write(*,*)'if co2plus is in traceur.def, all other ions must also be'
            write(*,*)'o2plus, oplus, coplus, cplus, nplus, noplus, n2plus'
            write(*,*)'hplus, hco2plus, hcoplus, h2oplus, h3oplus, ohplus, and elec'
            write(*,*)'stop'
         ...
         do i = 1,nbp_lon+1
            do j = 1,nbp_lat
               do l = 1,nbp_lev
                  ...
                  pq(i,j,l,igcm_h3oplus)  = 0.
                  pq(i,j,l,igcm_ohplus)   = 0.
         ...
         qsurf(1:ngrid,igcm_h3oplus)  = 0.
         qsurf(1:ngrid,igcm_ohplus)   = 0.
