...
cd IOIPSL
cp -f ../LMDZ.COMMON/arch/arch-centos-ifort-para.env arch
cp -f ../LMDZ.COMMON/arch/arch-centos-ifort-para.path arch
cp -f ../LMDZ.COMMON/arch/arch-centos-ifort-para.fcm arch

## 3. build ioipsl:
./makeioipsl_fcm -arch centos-ifort-para -job 8 > makeioipsl.out 2>&1
